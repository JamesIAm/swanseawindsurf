					...
					<div className="snippet row">
						...
						<div className="col-xs-12 col-xl-4">
							<div className="snippet_text">
								...
								<p>
									This year saw the return of Pondlife, and
									everyone was happy to see it. After the
									drive up, everyone descended on Bierkeller
									for a stein and a game of beer pong whilst
									we registered, and from there on to Bodega.
									<br />
									<br /> As Saturday night morning came the
									wind came with it. A massive wind gusting up
									to 30knots made for some fascinating
									advanced and team racing.
									<br />
									<br />
									Then Saturday night arrived. After a quick
									trip to Lidl for some last minute outfits,
									we donned our Greek outfits and headed out
									to Rescue Rooms. The Nottingham club has
									secured us a private room upstairs, which
									was fantastic and allowed for some full
									force SWA antics.
									<br />
									<br /> Sunday morning (it was the afternoon
									if we're being totally honest) saw the
									intermediate racing, and then everyone
									gathered by a smaller lake to watch the
									beginners race. Despite some unorthadox
									methods of propulsion, it was fantastic to
									see so many of our new members getting
						...
						<div className="col-xs-12 col-xl-4">
							<div className="snippet_text">
								...
								<p>
									...
									University hosted the first wave event of
									the year! Windsurfers from all around the
									country gathered in Costa del Swans for a
									weekend tearing up Wind Street and the waves
									on Trecco Bay.
									<br />
									<br />
									On Friday night, after checking into their 5
									star Brynmill homes, students hastily made
									their way to Swansea’s premier SU club,
									Tooters (!TOOT TOOT!). £1 shots, bombs and
									VK’s ensured that everyone was suitably
									drunk and ready to bogey on down to the
									cheesy hits that were delivered. The hot and
									sweaty night out was perfectly complimented
									with the chilly winds that promptly cured
									everyone’s hangovers the next morning.
									<br />
									<br />
									Windsurfers were delighted by the strong
									winds that greeted them on Saturday morning.
									With speeds of up to 30 knots Trecco Bay was
									the perfect place for intermediates and
									experts to show their wave sailing skills.
									The day consisted of some amazing free
									sailing and big efforts to warm up after.
									<br />
									<br />
									Following a quick clear up of the bay,
									students made their way back to Brynmill
									where their hunger was satisfied by Tescos
									finest pizzas. Dinner was followed by a
									round of pres and getting ready for the
									fancy-dress theme of social cliques. By 12,
									Swansea’s Bierkeller was full of goths,
									jocks and gap yarrrh travellers. Steins in
									hands and dancing on the table provided
									everyone with the messy night out they were
									after. Students staggered home in the early
									hours of the morning ensuring that they made
									one last stop at the kebab house on the way
									home.
									<br />
									<br />
									Sunday was a much slower start. Steins of
									beer were replaced with cups of coffee and
									crispy bacon sandwiches were a necessity.
									Due to the low winds many windsurfers
									decided not to drive to Trecco Bay but
									instead took an easy stroll on Swansea
									Beach. The sunshine and the sand was the
									perfect way to end the weekend and conclude
									everyone’s little holiday to Costa del
									Swans. Although racing and free style
									competitions did not take place, the event
									was still very much a success and enjoyed by
									all.
								</p>
								<div className="row buttons">
						...
						<div className="col-xs-12 col-xl-4">
							<div className="snippet_text">
								...
								<p>
									...
									Birmingham all alone for Up the Brum IV (due
									to some slight organisation issues by the
									rest of the committee).
									<br />
									<br /> But Jake was far from lonely, he met
									up with the UWE club and proceeded to enjoy
									Birmingham, stopping along the way to pick
									up a win in the Advanced racing.
								</p>
								<div className="row buttons">
					...
					<div className="snippet row">
						...
						<div className="col-xs-12 col-xl-4">
							<div className="snippet_text">
								...
								<p>
									We turned up on friday to find that the lake
									had unfortunately migrated to the field
									where we were supposed to be camping.
									Pressing on regardless we threw up some
									tents and headed over to the SWA party tent,
									until 2am when we all dragged ourselves in
									to bed considerably more muddy than when we
									left.
									<br />
									<br />
									For the Swans Saturday consisted of sitting
									on boards, enjoying the weather. Before
									grabbing some kit and heading out to have a
									play, or compete in the freestyle
									competition.
									<br />
									<br />
									For the Saturday night party, the boys and
									girls of Swansea dressed up as the opposite
									gender (for the theme of Opposites Attract)
									and headed back in to the even muddier party
									tent to enjoy the silent disco.
									<br /> <br />
									Sunday morning bought a fresh crop of
									hangovers and more importantly, a fresh
									breeze that allowed for some interesting
									racing. All yawns were instantly abondoned
									and the eager racers lept to action. After
									some nailbaiting races, some sleepy Swans
									set off home.
								</p>
								<div className="row buttons">
