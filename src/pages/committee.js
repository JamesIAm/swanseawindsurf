					...
					<div className="col-md-6 col-sm-12 top_trump">
						...
						<ul>
							...
							<li>
								...
								was about 12. And this year he takes on the role of pres.
								Harry loves any excuse for a good night out cant wait to 
								be back out in swans with old and new members.
							</li>
						</ul>
					</div>
					<div className="col-md-6 col-sm-12 top_trump">
